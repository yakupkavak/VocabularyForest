    ...
    func initalizeDailyQuests() -> [QuestModel] {
        return [
            ...
            QuestModel(
                ...
                type: .daily,
                title: "İki Yudum Su 💧",
                description: "Hafızanı canlandır: 10 eski kelimeyi tekrar et ve ustalaş!",
            ...
            QuestModel(
                ...
                type: .daily,
                title: "Sayısız Su 💧",
                description: "Hafızanı canlandır: 20 eski kelimeyi tekrar et ve ustalaş!",
            ...
            QuestModel(
                id: UUID(),
                type: .daily,
                title: "Yeni Keşifler 2🗺️",
                description: "10 yeni kelimeyle tanış ve anlamlarını öğren.",
                reward: .water(count: 10),
                status: .active,
                targetCount: 10,
                currentProgressCount: 0,
            ...
            QuestModel(
                id: UUID(),
                type: .daily,
                title: "Yeni Keşifler 3🗺️",
                description: "20 yeni kelimeyle tanış ve anlamlarını öğren.",
                reward: .water(count: 25),
                status: .active,
                targetCount: 20,
                currentProgressCount: 0,
